...
public class AskQuery extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.addAll( CommonShare.getAskQueryList(this));
    ...
    void showChoice()
    {
        ...
        if(new ConnectionDetector(AskQuery.this).isConnectingToInternet())
        {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                           ...
                           // intent.setType("* / *");
                            ...
                            startActivityForResult(intent, 26);*/
                                Intent intent = new Intent(AskQuery.this, FilePicker.class);
                                startActivityForResult(intent, 26);
                            }
                            dialog.dismiss();
                        }
            ...
            Toast.makeText(AskQuery.this, ("Please check internet connection"), Toast.LENGTH_LONG).show();
    ...
    public void onClick(View view) {
        ...
        if(spinerUser.getSelectedItemPosition()==0)
        {
            Toast.makeText(this, "Select Person to Send Message", Toast.LENGTH_SHORT).show();
            return;
        }
