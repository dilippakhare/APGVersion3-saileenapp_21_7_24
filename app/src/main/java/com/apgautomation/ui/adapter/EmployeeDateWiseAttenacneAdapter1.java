...
public class EmployeeDateWiseAttenacneAdapter1 extends ArrayAdapter {
   Context context;
   ArrayList<EmployeewithattendanceModel> list;
    public EmployeeDateWiseAttenacneAdapter1(@NonNull Context context, int resource, ArrayList<EmployeewithattendanceModel> list) {
