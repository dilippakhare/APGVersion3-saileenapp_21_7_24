...
public class EmployeeAttendanceList extends AppCompatActivity implements DownloadUtility
, DatePickerDialog.OnDateSetListener{
   ...
   Calendar myCalendar = Calendar.getInstance();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new DatePickerDialog(EmployeeAttendanceList.this, EmployeeAttendanceList.this, myCalendar
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(list.get(i).StatusName!=null && !list.get(i).StatusName.equalsIgnoreCase("") )
                  startActivity(new Intent(EmployeeAttendanceList.this,ViewAttenadnceDetails.class));
            }
        });
    }
    void callRequest()
    {
        ...
        String url= CommonShare.url+"Service1.svc/GetAttendanceRecordsByDateNew?ManagerId="+ManagerId+"&EmpId="+EmpId+"&Mode="+Mode+"&SelectedDate="+selectedDate;
    ...
    // CommonShare.alert(this,str);
        ...
        try
        {
            ...
            for(int i=0;i<arr.length();i++)
            {
             ...
             adapter=new EmployeeRecentAttenacneAdapter(this,R.layout.item_recent_attendance,list);
            listview.setAdapter(adapter);
